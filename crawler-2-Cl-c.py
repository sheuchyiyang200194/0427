#5.將json顯示並轉成檔案_request
import requests

url =('https://www.kkday.com/zh-tw/category/ajax_product_list?keyword=&currency='
      'TWD&sort=prec&page=1&start=0&count=10&destination=&availstartdate=&availenddate'
      '=&prodcat=CATEGORY_020%2CCATEGORY_023%2CCATEGORY_022%2CCATEGORY_025%2CCATEGORY'
      '_030%2CCATEGORY_028%2CCATEGORY_021%2CCATEGORY_026%2CCATEGORY_029%2CCATEGORY_'
      '024%2CCATEGORY_027&ave_score_from=&locations=&time=&glang=&row=10&fprice=*&'
      'eprice=*&immediately_use=0&sale_status=0&departure=&arrival=&travel_type'
      '=&rewrite=1&csrf_token_name=14faccbd1ae923f392b3d9dac1572866')
